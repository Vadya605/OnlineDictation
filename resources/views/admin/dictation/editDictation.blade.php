    ...
    <form class="mt-5" action="{{ route('admin.dictation.update', $dictation) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('title') is-invalid @enderror" 
                id="title" name="title" value="{{ old('title')?old('title'):$dictation->title }}"
            >
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" 
                id="video_link" name="video_link" value="{{ old('video_link')?old('video_link'):$dictation->video_link }}"
            >
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" 
                name="description" id="description" cols="30" rows="5">{{ old('description')?old('description'):$dictation->description }}
            </textarea>
        ...
        <div class="mb-3 form-check date-time-selection">
            ...
            <input type="datetime-local" class="form-check-input @error('from_date_time') is-invalid @enderror" 
                id="from_date_time" name="from_date_time" 
                value="{{ old('from_date_time')?old('from_date_time'):$dictation->from_date_time }}"
            >
        ...
        <div class="mb-3 form-check date-time-selection">
            ...
            <input type="datetime-local" class="form-check-input @error('to_date_time') is-invalid @enderror" 
                id="to_date_time" name="to_date_time" 
                value="{{ old('to_date_time')?old('to_date_time'):$dictation->to_date_time }}"
            >
